...
const BurnModal = ({ visible, burning, onBurn, onClose }) => {
  ...
  return (
    <Modal
      ...
      submitLabel={burning ? <ClipLoader color="#FFF" size={16} /> : 'Burn Now'}
      onSubmit={!burning ? () => handleTransfer() : null}
    >
      <div className={styles.formGroup}>
        This deletion confirmation will result in the permanent removal of your
        NFT and cannot be undone.
        <br />
        <br />
