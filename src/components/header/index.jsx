...
const Header = props => {
  ...
  const [DarkMode, setDarkMode] = React.useState(() => {
    ...
    return DarkValue !== null ? JSON.parse(DarkValue) : false;
  });
        ...
        <div className={'wrapper js-header-wrapper'}>
          ...
          <div className={cx('header__menu', styles.left)}>
            <ul className="d-flex space-x-20">
              ...
              */}
              <li>
                <NavLink to="/explore" className={'color_black'}>
                  Explore
                </NavLink>
              </li>
              {
                <li>
                  <NavLink to="/collections" className={'color_black'}>
                    Collections
                  </NavLink>
                </li>
              }
            ...
            {account ? (
              <>
                ...
                <HeaderAvatarMenu
                  ...
                  isAdmin={
                    account?.toLowerCase() &&
                    ADMIN_ADDRESS.includes(account?.toLowerCase())
                  }
            ...
            <div className="header__mobile__menu space-y-20">
              ...
              {account ? (
                <div className="col-md-12 col-sm-12">
                  <Link to="/create" className={'btn btn-warning w-full'}>
                    Create
                  </Link>
                </div>
              ) : (
