...
const AccountDetails = () => {
  ...
  const handleShareToTwitter = () => {
    handleClose();
    window.open(
      `https://twitter.com/intent/tweet?text=Check%20out%20this%20account%20on%20Pixelly&url=${window.location.href}`,
      '_blank'
    );
  };
      ...
      <div className={styles.profile}>
        <div className={styles.banner}>
          {loading ? (
            ...
            <img
              src={`https://pixellygg.mypinata.cloud/ipfs/${bannerHash ||
                user.bannerHash}`}
                        ...
                        activity.to ? (
                          ...
                          >
                            <div className={styles.ownerAvatarWrapper}>
                              {activity.image ? (
                                <img
                                  src={`https://pixellygg.mypinata.cloud/ipfs/${activity.image}`}
