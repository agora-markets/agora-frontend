          ...
          <div className="row md:space-y-20">
            ...
            <div className="col-lg-6">
              <div className="space-y-20">
                ...
                {multichainlist[address] && (
                  <div className={`${styles.panelWrapper} boxNoPad`}>
                    <Panel
                      title={`<b>${collection?.collectionName ||
                        collection?.name}</b> ARE CROSSCHAIN`}
                      icon={Transform}
                      fixed={true}
                      expanded={true}
                      containerClassName="px-20 border-none"
                    ...
                    >
                      <div className={styles.multichain}>
                        ...
                        <a
                          ...
                          target="_blank"
                          href="https://bridge.wanchain.org/#/nft"
                          rel="noreferrer"
                        >
                          <img src="/wanbridge.svg" alt="" />{' '}
                              ...
                              <div className={styles.buy}>
                                {listing.owner.toLowerCase() !==
                                  ...
                                  new Date(listing.startTime).getTime() +
                                    1000 * 86400 * 30 * 5 >=
                                    new Date().getTime() &&
                                  permanentlist[address.toLowerCase()] !==
                                    listing.owner.toLowerCase() && (
                                    <TxButton
                                      className={cx(
                                        'btn btn-primary btn-md rounded-20',
                                ...
                                {listing.owner.toLowerCase() !==
                                  ...
                                  new Date(listing.startTime).getTime() +
                                    ...
                                    new Date().getTime() &&
                                  permanentlist[address.toLowerCase()] !==
                                    listing.owner.toLowerCase() && <>Expired</>}
                              </div>
                            </div>
                          ))}
                    </div>
