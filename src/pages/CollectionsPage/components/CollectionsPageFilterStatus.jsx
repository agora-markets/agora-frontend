...
*/
  ...
  return (
    <div className="row justify-content-between align-items-center">
      ...
      <div style={{fontSize:20,fontWeight:'bold'}}><span style={{color:'rgba(255, 107, 199, 1)'}}>{props.count}</span> {props.onlyVerified ? 'Collections Verified' : 'Total Collections'}</div>
      </div>
