      ...
      if (listing.token.address === '') {
        ...
        if (balance.lt(price)) {
          const toastId = showToast(
            ...
            listing.token.symbol === 'WETH' || listing.token.symbol === 'WTENET'
    ...
    <Panel title="Chain Info" icon={BallotIcon}>
      <div className={styles.panelBody}>
        ...
        <div className={styles.panelLine}>
          ...
          <div className={styles.panelValue}>Tenet</div>
        </div>
        <div className={styles.panelLine}>
          <div className={styles.panelLabel}>Chain ID</div>
          <div className={styles.panelValue}>1559</div>
        </div>
      </div>
    </Panel>
  );
                    ...
                    {history ? (
                      <Link to={`/account/${history.from}`}>
                        <div className={styles.userAvatarWrapper}>
                          {history.fromImage ? (
                            <img
                              src={`https://pixellygg.mypinata.cloud/ipfs/${history.fromImage}`}
                              className={styles.userAvatar}
                            />
                          ) : (
                            <Identicon
                    ...
                    {history ? (
                      <Link to={`/account/${history.to}`}>
                        <div className={styles.userAvatarWrapper}>
                          {history.toImage ? (
                            <img
                              src={`https://pixellygg.mypinata.cloud/ipfs/${history.toImage}`}
                              className={styles.userAvatar}
                            />
                          ) : (
                            <Identicon
