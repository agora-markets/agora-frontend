  ...
  const collectionsLaunchpad = [
    {
      ...
      description: (
        <div>
          <p>
            CSG is a collection of 10,000 unique, cute and shaggy creatures
            living on the Cronos chain. Owning a Shaggy grants you access to the
            ShaggyDAO. We are building a sustainable community for NFT
            enthusiasts on Cronos chain. Shaggies allow you to create and vote
            on DAO Polls in order to make your voice heard. Get involved and
          ...
          <h4>$COMB Airdrop</h4>
          <p>
            Upon reaching Phase 3 of our roadmap, $COMB token liquidity will be
            provided on VVSFinance. $COMB serves as a utility token for the
            project and can be burned, reducing its total supply. Shaggy hodlers
            will be able to redeem their share on a weekly basis during one
            year.
          </p>
          <br></br>
          <h4>Marketplace Royalties</h4>
          <p>
            As our main goal is to reward long-term hodlers, our marketplace
            charges a 7.5% commission on each Shaggy sold that will be
            redistributed.
          </p>
        </div>
      ),
